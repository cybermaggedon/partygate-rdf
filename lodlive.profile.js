$.jStorage.set('profile',
               {
			       ...
			       document : 'SELECT DISTINCT * WHERE {<{URI}> ?property ?object}',
                           ...
                           examples : [
			       {
				   uri: 'http://e623fd-partygate/may-15-wine-cheese',
				   label: 'May 15 2020, Wine and Cheese party'
                               },
			       {
				   uri: 'http://e623fd-partygate/suitcase-of-wine',
				   label: 'Suitcase of wine party'
			       },
			       {
				   uri: 'http://e623fd-partygate/dec-18-no10-party',
				   label: 'Dec 18 2020, 10 Downing Street'
			       },
			       {
				   uri: 'http://e623fd-partygate/dec-14-cchq',
				   label: 'Dec 14 2020, CCHQ'
			       },
			       {
				   uri: 'http://e623fd-partygate/alcohol',
				   label: 'Alcohol'
			       },
			       {
				   uri: 'http://e623fd-partygate/party',
				   label: 'Party'
			       },
			       {
				   uri: 'http://e623fd-partygate/no-10',
				   label: 'Number 10'
			       },
			       {
				   uri: 'http://e623fd-partygate/london-tier-2-lockdown',
				   label: 'London tier 2 lockdown'
			       }
			   ]
                       }
                   },
